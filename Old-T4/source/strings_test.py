...
class StringsTest(unittest.TestCase):
    def test_contains_with_matching_patterns(self):
        ...
        # assert contains('daniel', 'da') is True
        # assert contains('daniel', 'ni') is True
        # assert contains('daniel', 'el') is True
    ...
    def test_contains_with_non_matching_patterns(self):
        ...
        # assert contains('daniel', 'do') is False
        # assert contains('daniel', 'ane') is False
        # assert contains('daniel', 'iol') is False
        # assert contains('daniel', 'danuel') is False
    ...
    def test_contains_with_complex_patterns(self):
        ...
        # assert contains('Daniel is amazing', 'isa') is True
        # assert contains('Linux for the win', 'uxf') is True
        # assert contains('Grass is green', 'een') is True
    ...
    def test_find_index_with_matching_patterns(self):
        ...
        # assert find_index('allan', 'll') == 1
        # assert find_index('allan', 'n') == 4
        # assert find_index('allan', 'lan') == 2
    ...
    def test_find_index_with_non_matching_patterns(self):
        ...
        # assert find_index('jeremy', 'jeri') is None 
        # assert find_index('jeremy', 'jir') is None
        # assert find_index('jeremy', 'emi') is None
    ...
    def test_find_index_with_complex_patterns(self):
        ...
        # TODO: Write more test cases that check complex patterns or edge cases
        # assert find_index('kanye is going to coachella', 'hell') == 22
        # assert find_index('kanye is going to coachella', 'ye') == 2
        # assert find_index('kanye is going to coachella', 'going') == 9
    ...
    def test_find_all_indexes_with_matching_patterns(self):
        ...
        # assert find_all_indexes('ariana grande is not cute', 'not') == [17,18,19]
        # assert find_all_indexes('ariana grande is not cute', 'ria') == [1,2,3]
        # assert find_all_indexes('ariana grande is not cute', ' gran') == [6,7,8,9,10] 
    ...
    def test_find_all_indexes_with_non_matching_patterns(self):
        ...
        # assert find_all_indexes('forever is not 4ever', '5ever') == []
        # assert find_all_indexes('forever is not 4ever', 'fourever') == []
        # assert find_all_indexes('forever is not 4ever', 'even') == []
    ...
    def test_find_all_indexes_with_complex_patterns(self):
        ...
        # TODO: Write more test cases that check complex patterns or edge cases
        # assert find_all_indexes('heisenberg or the hindenburg', 'berg') == [6]
        # assert find_all_indexes('heisenberg or the hindenburg', 'burg') == [20]
        # assert find_all_indexes('heisenberg or the hindenburg', 'b') == [6,24]
